...
public class ShopConfig {
    ...
    private final JwtUtils jwtUtils;  // Inject JwtUtils directly here
    ...
    // No need to pass arguments to authTokenFilter here, it will use the injected JwtUtils and ShopUserDetailsService
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(authTokenFilter(), UsernamePasswordAuthenticationFilter.class); // Now it will use the injected bean
        return http.build();
    }
}
